...
import { FaFacebook, FaTwitter, FaChevronDown, FaExternalLinkAlt } from "react-icons/fa";
...
export default function BlogsPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto p-6">
      <h1 className="text-4xl font-bold mb-6 text-center">Interview Question Blogs</h1>
          ...
          <div key={section.mainHeader} className="mb-4 border rounded-lg overflow-hidden">
            ...
            <div className="flex items-center justify-between px-4 py-3 bg-gray-50">
              <div className="flex items-center gap-3">
                <span className="font-semibold text-lg">{section.mainHeader}</span>
              ...
              <button
                ...
                onClick={() =>
                  setExpandedSection(isOpen ? null : section.mainHeader)
                }
